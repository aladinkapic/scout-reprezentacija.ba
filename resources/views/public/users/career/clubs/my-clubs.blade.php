    ...
    <div class="my__profile__wrapper">
        ...
        <div class="content__part">
            <div class="content__menu">
                <h4>{{ __('Moji klubovi') }}</h4>

                <div class="cm__btns_w">
                    <a href="{{ route('profile.career-data.clubs.new-club') }}" title="{{ __('Unesite informacije o novom klubu') }}">
