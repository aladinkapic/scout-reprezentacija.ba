            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        {!! Form::text('fname', Auth()->user()->fname ?? '', ['class' => 'form-control required', 'id' => 'fname', 'aria-describedby' => 'fnameHelp', 'maxlength' => '50']) !!}
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        {!! Form::text('lname', Auth()->user()->lname ?? '', ['class' => 'form-control required', 'id' => 'lname', 'aria-describedby' => 'lnameHelp', 'maxlength' => '50']) !!}
