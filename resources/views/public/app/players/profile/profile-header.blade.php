...
{{--    <svg  class="header-bcg" viewBox="0 0 1496 265" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet">--}}
{{--        <defs>--}}
...
{{--                    </div>--}}
            ...
            <div class="share-on-social-networks">
                <div class="sos-wrapper" title="{{ __('Podijelite na Facebook-u') }}" onclick="window.open('https://www.facebook.com/sharer/sharer.php?u={{ route('home.players.player-timeline', ['username' => $player->username] ) }}', '_blank', 'location=yes,height=570,width=520,scrollbars=yes,status=yes');">
                ...
                <div class="sos-wrapper" title="{{ __('Podijelite na Twitter-u') }}" onclick="window.open('https://twitter.com/intent/tweet?url={{ route('home.players.player-info', ['username' => $player->username] ) }}', '_blank', 'location=yes,height=570,width=520,scrollbars=yes,status=yes');">
                ...
                <div class="sos-wrapper" title="{{ __('Prijavite netačne podatke') }}">
