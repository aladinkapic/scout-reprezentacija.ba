...
{{--      <a href="#" class="footer-nav-item">Reprezentacija.BA</a>--}}
{{--      <a href="#" class="footer-nav-item">Prijava</a>--}}
{{--      <a href="#" class="footer-nav-item">Kontakt</a>--}}
{{--    </div>--}}
{{--  </div>--}}
...
{{--      </div>--}}
{{--      <div class="copyright">© Reprezentacija.ba - All rights reserved</div>--}}
{{--    </div>--}}
{{--</footer>--}}
...
{{--        </ul>--}}
{{--        <p class="copyright">Crafted with <i class="fas fa-heart text-danger"></i> by <a href="https://alkaris.com" class="text-info text-decoration-none"> <b>Alkaris d.o.o</b> </a></p>--}}
{{--    </footer>--}}
{{--</div>--}}
...
{{--                        <img src="{{ asset('images/socials/fbWhite.png') }}" alt="Facebook icon"/>--}}
{{--                    </a>--}}
{{--                    <a href="https://www.instagram.com/kviz.znzkvi/" target="_blank">--}}
{{--                        <img src="{{ asset('images/socials/instagramWhite.png') }}" alt="Instagram icon"/>--}}
{{--                    </a>--}}
{{--                    <a href="https://www.youtube.com/@HelemNejse" target="_blank">--}}
{{--                        <img src="{{ asset('images/socials/youtubeWhite.png') }}" alt="Youtube icon"/>--}}
{{--                    </a>--}}
                </div>
            </div>
            <div class="footer__con-right">
                ...
                <ul class="footer__list2">
                    ...
                    <li class="footer__list2-item">
                        <a class="footer__list2-link" href="https://reprezentacija.ba/">{{ __('www.reprezentacija.ba') }}</a>
                    </li>
                </ul>
            </div>
        </div>
